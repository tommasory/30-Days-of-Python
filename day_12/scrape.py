...
# Nos muestra el nombre de la carpeta donde está este archivo.
...
* python -i day_12/scrape.py
* url_to_txt('https://www.boxofficemojo.com/year/world/',save=True)
"""
...
def url_to_txt(url, filename="world.html", save=False):
    ...
    if r.status_code == 200:
        html_text = r.text
        if save:
            with open(f"{BASE_DIR}/world-{YEAR}.html", 'w', encoding="utf-8") as f:
                f.write(html_text)
        return html_text
    return None
